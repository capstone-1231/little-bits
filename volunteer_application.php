...
<body>
    <main>
        ...
        <form>
            ...
            <label for="whyChooseLittleBits">How did you hear about us and what made you choose us as a place to
                volunteer?</label>
            ...
            <label for="additionalSkills">Please list any additional skills or interests that you would be willing to
                share with Little Bits:</label>
            ...
            <h3>REFERENCE</h3>
            <p>Little Bits Therapeutic Riding Association requires that all new volunteers provide information for two
                references. These may come from teachers, employers, other agencies you volunteer with, coworkers, etc.
            </p>
